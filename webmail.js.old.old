(() => {
  ...
  const el = {
    ...
    composeTo: $('composeTo'), composeSubject: $('composeSubject'), composeBody: $('composeBody'), sendBtn: $('sendBtn'), composeToolbar:$('composeToolbar'), inlineImageInput:$('inlineImageInput'), attachmentInput:$('attachmentInput'), htmlImportInput:$('htmlImportInput'), composeFiles:$('composeFiles'),
